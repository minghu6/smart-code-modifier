// Generated from /home/minghu6/coding/CL/myworkspaces/smart-code-modifier/py1/codefmt/phpparser/PhpParser.g4 by ANTLR 4.8
...
public class PhpParser extends Parser {
	...
	public static final int
		...
		RULE_innerStatement = 26, RULE_statement = 27, RULE_emptyStatement = 28, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"Finally", "FloatCast", "For", "Foreach", "Function", "Global", "Goto", 
	...
	public final ClassDeclarationContext classDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << AttributeStart) | (1L << Abstract) | (1L << Const))) != 0) || ((((_la - 76)) & ~0x3f) == 0 && ((1L << (_la - 76)) & ((1L << (Final - 76)) | (1L << (Function - 76)) | (1L << (Private - 76)) | (1L << (Protected - 76)) | (1L << (Public - 76)) | (1L << (Static - 76)) | (1L << (Use - 76)) | (1L << (Var - 76)))) != 0)) {
				{
				{
				setState(448);
				classStatement();
