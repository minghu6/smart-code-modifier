...
class PhpParser ( Parser ):
    ...
    def classDeclaration(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << PhpParser.AttributeStart) | (1 << PhpParser.Abstract) | (1 << PhpParser.Const))) != 0) or ((((_la - 76)) & ~0x3f) == 0 and ((1 << (_la - 76)) & ((1 << (PhpParser.Final - 76)) | (1 << (PhpParser.Function - 76)) | (1 << (PhpParser.Private - 76)) | (1 << (PhpParser.Protected - 76)) | (1 << (PhpParser.Public - 76)) | (1 << (PhpParser.Static - 76)) | (1 << (PhpParser.Use - 76)) | (1 << (PhpParser.Var - 76)))) != 0):
                self.state = 448
                self.classStatement()
                self.state = 453
                self._errHandler.sync(self)
    ...
    def classStatement(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [PhpParser.AttributeStart, PhpParser.Abstract, PhpParser.Const, PhpParser.Final, PhpParser.Function, PhpParser.Private, PhpParser.Protected, PhpParser.Public, PhpParser.Static, PhpParser.Var]:
                self.enterOuterAlt(localctx, 1)
                self.state = 950
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                ...
                if la_ == 1:
                    ...
                    if token in [PhpParser.Const]:
                        ...
                        self.match(PhpParser.SemiColon)
                        pass
                    elif token in [PhpParser.Function]:
                        self.state = 983
                        self.match(PhpParser.Function)
                        self.state = 985
                        self._errHandler.sync(self)
